...
[LinkedIn](https://www.linkedin.com/in/danielpassy/)</br>
[Github](https://github.com/danielpassy/) </br>
<daniel.passy@gmail.com></br>
[+55 (21) 99757-0933](https://web.whatsapp.com/send?phone=5521997570933) </br>
...
### Engenheiro de Software Sênior - Eden
#### 05/2025 - Presente · Remoto (México)
...
- Migração de sistemas on-premisses para um modelo de plataforma SaaS.
- Desenvolvimento e manutenção de tooling de plataforma: build, CI/CD, cache, tracing, logging, filas e testes.
- Desenvolvimento de serviços backend e componentes compartilhados em Python/Django.
- Migração de pipelines do Jenkins para GitHub Actions, com padronização de deploys SaaS.
- Melhoria de tempos de build e da confiabilidade dos deploys.
- Resolução de incidentes complexos como time responsável pela etapa final de resolução, abrangendo infraestrutura e aplicação.
- Referência técnica do time em arquitetura de plataforma e confiabilidade.

### Tech Lead - Buser Brasil
#### 12/2022 - 03/2022

- Desenvolvimento Vue, Django, Flutter, Gitlab CI, Docker, deploy Kubernetes.
- Corresponsável por cerimônias Agile – Planning, refining, retro, daily.
- Referência técnica em um time de 5 desenvolvedores,
...
- Modelagem de dados, pesquisa de mercado, criação e apresentação de decks .ppt
- Trabalho 100% em inglês

### Estagiário em simulações físico-químicas
#### 09/2018 - 05/2019

- Modelagem estatística para design de equipamentos para indústria de óleo e gás
- Implementação em C++ usando OpenFOAM
