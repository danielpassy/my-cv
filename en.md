...
- Built backend services and shared components in Python/Django to support product teams at scale.
- Migrated legacy Jenkins pipelines to GitHub Actions, centralizing and standardizing SaaS deployment workflows.
- Improved developer experience by reducing build times, increasing deployment reliability, and enforcing platform standards.
...
- Vue 2, Vue 3, Django, Flutter, GitLab CI, Docker, and Kubernetes deployments.
